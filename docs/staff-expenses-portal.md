...
- לפני הצגת מסך הכניסה נבדקים PHP 8.1 ומעלה, session פעיל, `fileinfo`, מגבלות ההעלאה, transport לדוא״ל וכתיבה/קריאה/מחיקה של קובץ בדיקה בתיקייה הפרטית. כשל מחזיר עמוד תחזוקה ו-HTTP 503 ללא חשיפת פרטי שרת.
