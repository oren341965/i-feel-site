...
במצב מתוזמר זה אין לשנות קוד, לפתוח משימת Monday, לשלוח טיוטת Gmail או לפתוח Draft PR. החזר הצעה בלבד עם מקור הראיה, timestamp ורמת confidence. מסלול התיקון ופתיחת ה־Draft PR מותר רק כאשר אורן מפעיל ומאשר אותו בנפרד; merge ופריסה נשארים שערים מפורשים נוספים.
