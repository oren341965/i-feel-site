  ...
  return {
    ...
    dailyWebsiteImprovement: {
      ...
      acceptedSalesFeedback: [
        ...
        'ai_referral_pages',
        'ai_referral_leads',
        'newsletter_opt_in_rate',
      ],
    },
    aiDiscovery: {
      included: true,
      engines: ['ChatGPT', 'Gemini', 'Claude', 'Perplexity', 'Microsoft Copilot'],
      discoveryPolicy: 'STANDARD_SEO_PLUS_ORIGINAL_EVIDENCE',
      crawlerAccessMustBeVerified: true,
      referralAttributionRequired: true,
      automaticPublishAllowed: false,
    ...
    newsletterGrowth: {
      ...
      restoreUnsubscribedContactsAllowed: false,
      draftOnly: true,
      sendAllowed: false,
      automaticCampaignAllowed: false,
    },
    attribution: {
