...
4. Accept only `INSTALLED_PAUSED` with four of four Codex Skill hashes, both task-contract hashes, zero runtime locks, zero scheduler activations, zero sends, zero Monday writes and zero deletions.
