...
- Front-office worker for the verified Maya Gmail, Instagram and WhatsApp accounts under each canonical Maya skill's own limits.
...
- Does not own pipeline or marketing strategy, Instagram audience/watchlist policy, Monday structure, advertising, budgets, source code, or approval policy.
...
- Owns the Instagram professional-relations idea, backlog, relationship objective, audience and watchlist governance, message policy, monthly quality review and canonical Maya-skill lifecycle.
