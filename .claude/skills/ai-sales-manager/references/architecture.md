...
3. **Workers** — paid media, attribution, service, content, website, Maya, plans, quote quality, referrals, handoff, and closeout skills. A worker owns its domain operation; the sales manager owns sales orchestration and reconciliation, while `ai-marketing-manager` owns demand-generation strategy.
...
- Maya is a front-office worker, not a second sales or marketing manager. For the Monday-sourced Instagram/Facebook professional-relations program, `ai-sales-manager` supplies the reconciled roster and project evidence, `ai-marketing-manager` owns strategy and watchlist governance, and Maya owns only public-profile resolution, the verified monthly review, evidence and drafts. Communication permissions do not transfer between them.
