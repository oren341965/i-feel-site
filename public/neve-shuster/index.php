...
$priceGroups = [
    [
        ...
        'rows' => [
            ['TW601090-916-R-WA', 'מפסק זכוכית טאץ Z-Wave עד 9 לחצנים TouchWand, כולל חיישן קרבה משולב, 6 מעגלים להזנות ישירות ועד 3 תרחישים', 'דורש 0 במפסק מצד החשמלאי + קופסת עומק 3 מקום שוכב', '1,470', 'panel9.jpg'],
            ['Glasswand 1-b w', 'מפסק זכוכית טאץ מהודר, לחצן בודד לתאורה, חיווי אור בהפעלה, ללא כיתוב, בצבע לבן', 'דורש 0 במפסק התאורה מצד החשמלאי', '660', 'glass-1b.jpg'],
            ['Glasswand 2-b w', 'מפסק זכוכית טאץ מהודר, 2 לחצנים לתאורה, חיווי אור בהפעלה, ללא כיתוב, בצבע לבן', 'דורש 0 במפסק התאורה מצד החשמלאי', '676', 'glass-2b.jpg'],
            ['Glasswand 3-b w', 'מפסק זכוכית טאץ מהודר, 3 לחצנים לתאורה, חיווי אור בהפעלה, ללא כיתוב, בצבע לבן', 'דורש 0 במפסק התאורה מצד החשמלאי', '690', 'glass-3b.jpg'],
            ['Glasswand 2-shut w', 'מפסק תריס זכוכית טאץ מהודר לעליית והורדת התריס, חיווי אור בהפעלה, ללא כיתוב, בצבע לבן', 'דורש 0 במפסק התאורה מצד החשמלאי', '690', 'glass-shutter.jpg'],
            ['129020', 'מפסק זכוכית לתנור אמבטיה Z-Wave 16A, כולל חיבור וניתוק בנפרד', 'מותקן במקום מפסק תנור של הקבלן', '696', 'glass-boiler-timer.jpg'],
            ['16A GLASS', 'שקע נשלט בגימור זכוכית, עומס מרבי 16A. מיועד לפלטה חשמלית או לכל צרכן אחר שרוצים לשלוט בו: כיבוי והדלקה מהאפליקציה, לוח זמנים קבוע מראש ומצב שבת', 'מותקן במקום שקע רגיל, דורש 0 בנקודה מצד החשמלאי', '649', 'glass-boiler-timer.jpg'],
            ['IFW-ICON', 'שינוי אייקונים במפסק לפי בקשת הדייר, סימון מותאם אישית של הלחצנים במקום הסימון הסטנדרטי של הפרויקט', 'המחיר למפסק. נדרש להעביר את בקשת האייקונים לפני ההזמנה', '200', ''],
            ['IFW-BLACK', 'שינוי גוון המפסק מלבן לשחור', 'המחיר למפסק. יש לציין את הבחירה מראש, לפני ההזמנה', '200', ''],
            ['TW303100-916-E', 'מיקרומודול 230V, יחידה פנימית מאחורי מפסק הקבלן, עד 5 אמפר לערוץ ומקסימום 120 וואט. מתאים לכיבוי והדלקה של 2 מעגלי תאורה צמודים או תריס אחד', 'דורש 0 במפסק התאורה מצד החשמלאי', '556', 'micromodule.jpg'],
            ['IFW008', 'שינויי תכנות למסך המגע הקיים בדירה או תוספת רכיב הפעלה', '', '674', 'touchscreen.jpg'],
            ['TW303200-916-E', 'מתאם אלחוטי לתריסי או צלוני 24V, תריס כלוא בין חלונות. רלוונטי רק אם קיים בדירה צלון מסוג זה', 'בכמויות מסוימות עשוי להידרש ספק כוח 24V 4.2A בעלות 264 ש"ח בתוספת מע"מ', '660', 'micromodule-24v.jpg'],
        ],
    ],
    [
        'title' => 'אודיו',
        'note' => 'נדרשת פגישת התאמה עם נציג I Feel לפי טיפוס הדירה. הפגישות מתקיימות בזום, ואפשר לתאם אותן מול מאיה כהן.',
        'rows' => [
            ['10000', 'זוג רמקולים קדמיים סטליטיים, רסיבר עם תמונת TV וכבילה ייעודית', '', '6,744', 'audio-satellites.jpg'],
            ['מקרני קול', 'סאונדבר אלחוטי איכותי לאזור הסלון, כולל סאב ומתלה. מגוון דגמים בהתאמה לדייר ולתקציב, מדגמי כניסה ועד Klipsch Flexus Core 300 בתצורת 5.1.2 עם Dolby Atmos וסאבוופרים מובנים', 'ללא צורך בהכנות חשמלאי, נדרש שקע חשמל בלבד', '1,800 עד 4,500', 'soundbar-klipsch.jpg', 'https://www.klipsch.com/uk/products/flexus-core-300/', 'לדוגמה: Klipsch Flexus Core 300'],
        ],
    ],
    [
        'title' => 'אזעקה אלחוטית',
        'note' => 'כל הגלאים אלחוטיים ומבוססי בטריה. אין צורך בתשתיות ובעבודת חשמלאי, וזה חוסך לכם הכנות יקרות בזמן הבנייה. נדרשת פגישת התאמה עם נציג I Feel לפי טיפוס הדירה, הפגישות מתקיימות בזום ואפשר לתאם אותן מול מאיה כהן.',
        'rows' => [
            ['10000', 'גלאי מגנט לדלת או לחלון, או גלאי נפח אלחוטי, מבוססי בטריה פנימית', 'אלחוטי לחלוטין, ללא הכנות מצד החשמלאי', '552', ''],
            ['10000', 'גלאי עשן אלחוטי מבוסס בטריה', 'אלחוטי לחלוטין, ללא הכנות מצד החשמלאי', '576', ''],
            ['10000', 'גלאי הצפה אלחוטי מבוסס בטריה, מתריע ברגע שמזוהים מים על הרצפה', 'אלחוטי לחלוטין, ללא הכנות מצד החשמלאי. מותקן מתחת לכיור, ליד מכונת הכביסה או בחדר הרחצה', '516', 'detector-flood.jpg', 'https://i-feel.co.il/articles/water-leak-sensors-smart-home/', 'מדריך: גלאי נזילות בבית חכם'],
            ['WiComm Pro', 'מערכת אזעקה אלחוטית Risco WiComm Pro. ערכת הבסיס כוללת כבר גלאי מגנט אלחוטי לדלת, גלאי נפח אלחוטי ומקלדת', 'אלחוטי לחלוטין, ללא הכנות מצד החשמלאי. ניתן להרחיב בגלאים נוספים בכל שלב', '3,600', ''],
        ],
    ],
];
...
<main class="main">
  <div class="shell">
    ...
    <section class="card" id="pricelist">
      ...
      <p class="lead">מחירון ייעודי לשכונת הפרדס, רעננה. כל המחירים בשקלים חדשים, <strong>אינם כוללים מע״מ</strong>, ו<strong>אינם כוללים את עבודת ההתקנה</strong>, שמתומחרת בנפרד.</p>
      ...
      <?php foreach ($priceGroups as $group): ?>
        <div class="table-wrap">
          <table>
            ...
            <thead>
              <tr><th scope="col" class="th-img">תמונה</th><th scope="col">תיאור הפריט</th><th scope="col">מק״ט</th><th scope="col">מחיר יחידה<br><small style="font-weight:400">ללא מע״מ, ללא התקנה</small></th></tr>
            </thead>
            <tbody>
      ...
      <div class="notice">
        ...
        המחירים אינם כוללים מע״מ. עבודת ההתקנה מתומחרת בנפרד ואינה כלולה במחיר היחידה. כמו כן המחירים אינם כוללים את עבודת החשמלאי מטעם קבלן החשמל בפרויקט, ואת העלות הסופית של עבודת החשמלאי יש לבדוק מול מתאמת שינויי הדיירים של הפרויקט. ט.ל.ח.
      </div>
      <div class="callout">
        <strong>התאמה אישית של המפסקים</strong>
        המפסקים מגיעים בסימון האייקונים הסטנדרטי של הפרויקט ובגוון לבן. אפשר לשנות: <strong>תכנון אחר של האייקונים במפסק, לפי הבקשה שלכם, בעלות 200 ₪ למפסק</strong> — זה דורש מאיתנו להזמין ולהטמיע אייקונים נוספים. וגם <strong>שינוי הגוון מלבן לשחור, בעלות 200 ₪ למפסק</strong>, למי שרוצה. את שתי הבחירות צריך למסור לפני ההזמנה. רוצים לראות איך זה נראה? <a href="https://i-feel.co.il/switch-configurator/" rel="noopener" target="_blank">מגדיר המפסקים שלנו</a> מדגים את האפשרויות.
      </div>
