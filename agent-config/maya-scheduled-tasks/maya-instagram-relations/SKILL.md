...
Do not send a direct message; post a public comment; like, react, save, share, follow or unfollow; change Instagram settings; contact an unapproved account; alter the program brief, watchlist policy or installed skill; write Monday, Gmail, WhatsApp, contacts, the Vault or the Bus; or activate a scheduler. Do not claim that an approval was granted merely because this task ran.

Return the canonical monthly result and always include `PROGRAM_OWNER=ai-sales-manager`, `EXTERNAL_ACTIONS=0`, `SENDS=0`, `COMMENTS=0`, `REACTIONS=0`, `FOLLOWS=0`, `NEXT_ELIGIBLE_MONTH`, and bounded blocker codes.
