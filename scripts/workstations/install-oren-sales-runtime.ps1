...
$config.paidMediaBudget.enabled = $true
$config.paidMediaBudget.currency = 'ILS'
$config.paidMediaBudget.monthlyCapNis = 4000
$config.paidMediaBudget.googleAverageDailyBudgetCapNis = 50
$config.paidMediaBudget.maxEvidenceAgeHours = 24
$config.paidMediaBudget.platforms = @('GOOGLE_ADS', 'META_ADS')
$config.paidMediaBudget.automaticBudgetIncreaseAllowed = $false
$config.paidMediaBudget.temporaryPortfolioUntil = '2026-09-30'
$config.paidMediaBudget.priority = @('KNX_DDC', 'BMS', 'VILLA')
$config.paidMediaBudget.ownerApprovedGoogleDailyBudgetsNis.KNX_DDC = 40
$config.paidMediaBudget.ownerApprovedGoogleDailyBudgetsNis.BMS = 5
$config.paidMediaBudget.ownerApprovedGoogleDailyBudgetsNis.VILLA = 5
